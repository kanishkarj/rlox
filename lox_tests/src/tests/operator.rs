...
use super::*;
            ...
            test_fail!(
                ...
                test_succeed!(
                    ...
                    true,false,false,true,true,false,false,false,true,false,true,true,false,false,false,false,true,true,true,true
                );

                
                test_succeed!(
                    divide,
                    ".././test-scripts/operator/divide.lox",
                    4,1
                );
            ...
            test_fail!(
                ...
                test_succeed!(
                    negate,
                    ".././test-scripts/operator/negate.lox",
                    -3,3,-3
                );
            ...
            test_fail!(
                ...
                test_fail!(
                    ...
                    LoxError::RuntimeError(String::from("*"), 2, String::from(""))
                );
                ...
                test_succeed!(
                    subtract,
                    ".././test-scripts/operator/subtract.lox",
                    1,0
                );
